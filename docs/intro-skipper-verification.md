...
- Disabled Setting: turn off Settings -> Playback -> Intro Skipper, start a new playback item, and confirm neither intro nor credit segments are fetched or applied.
