...
const lightColorValue = {
  ...
  onPrimary: '#ffffff',
  onPrimaryContainer: '#17175c',
  onSecondary: '#ffffff',
  onSecondaryContainer: '#17175c',
  onSurface: '#191b23',
  onSurfaceVariant: '#454654',
  onTertiary: '#ffffff',
  ...
  primaryGradientEnd: '#6667f1',
  secondary: '#565dc2',
  secondaryContainer: '#e1e0ff',
  secondaryGradientEnd: '#2d6f85',
  surface: '#f7f8fc',
  surfaceContainer: '#ececf4',
  surfaceContainerHigh: '#e6e6ee',
  surfaceContainerHighest: '#e0e1e9',
  surfaceContainerLow: '#f2f2fa',
  surfaceContainerLowest: '#ffffff',
  surfaceTint: '#4f46e5',
  surfaceVariant: '#e2e1ec',
  tertiary: '#087f5b',
  tertiaryContainer: '#a7f2d8',
  warning: '#825500',
...
createGlobalTheme(':root[data-theme="light"]', projectTheme, {
  ...sharedThemeValue,
  color: lightColorValue,
});

createGlobalTheme(':root[data-theme="dark"]', projectTheme, {
  ...sharedThemeValue,
