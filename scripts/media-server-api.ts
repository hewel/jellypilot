...
const providers: Record<'jellyfin' | 'emby', Provider> = {
  jellyfin: {
    ...
    snapshotPath: 'crates/media-server-api/openapi/jellyfin-openapi-stable.json',
    configPath: 'crates/media-server-api/openapi/jellyfin-api-generator.json',
  ...
  emby: {
    ...
    snapshotPath: 'crates/media-server-api/openapi/emby-openapi-4.9.3.0.json',
    configPath: 'crates/media-server-api/openapi/emby-api-generator.json',
    outputDir: 'crates/media-server-api/emby',
