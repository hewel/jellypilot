...
pub enum JellyfinError {
  ...
  #[error(transparent)]
  ImageReference(#[from] ImageRefError),

  #[error("image reference provider mismatch")]
  ImageReferenceProviderMismatch,

  #[error("image reference server mismatch")]
  ImageReferenceServerMismatch,
